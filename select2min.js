/*! Select2 4.0.6-rc.1 | https://github.com/select2/select2/blob/master/LICENSE.md */ ! function (e) {
    ...
    var t = function () {
            ...
            return function () {
                ...
                t && t.requirejs || (t ? n = t : t = {}, function (t) {
                    ...
                    function o(e, t) {
                        var n, i, r, o, s, a, l, c, u, d, p, h = t && t.split("/"),
                            ...
                            g = f && f["*"] || {};
                        if (e) {
                            for (s = (e = e.split("/")).length - 1, v.nodeIdCompat && $.test(e[s]) && (e[s] = e[s].replace($, "")), "." === e[0].charAt(0) && h && (e = h.slice(0, h.length - 1).concat(e)), u = 0; u < e.length; u++)
                    ...
                    h = function (e, t) {
                        var n, i = c(e),
                            r = i[0],
                            s = t[1];
                        return e = i[1], r && (n = l(r = o(r, s))), r ? e = n && n.normalize ? n.normalize(e, function (e) {
                            return function (t) {
                                return o(t, e)
                            }
                        }(s)) : o(e, s) : (r = (i = c(e = o(e, s)))[0], e = i[1], r && (n = l(r))), {
                            f: r ? r + "!" + e : e,
                            n: e,
                            pr: r,
                            p: n
                        ...
                        var c, d, p, v, _, w, $, b = [],
                            x = typeof i;
                        if (w = u(o = o || e), "undefined" === x || "function" === x) {
                            for (n = !n.length && i.length ? ["require", "exports", "module"] : n, _ = 0; _ < n.length; _ += 1)
                                if ("require" === (d = (v = h(n[_], w)).f)) b[_] = f.require(e);
                                else if ("exports" === d) b[_] = f.exports(e), $ = !0;
                            else if ("module" === d) c = b[_] = f.module(e);
                            else if (r(g, d) || r(m, d) || r(y, d)) b[_] = l(d);
                            else {
                                if (!v.p) throw new Error(e + " missing " + d);
                                v.p.load(v.n, s(o, !0), a(d), {}), b[_] = g[d]
                            }
                            p = i ? i.apply(g[e], b) : void 0, e && (c && c.exports !== t && c.exports !== g[e] ? g[e] = c.exports : p === t && $ || (g[e] = p))
                        } else e && (g[e] = i)
                        ...
                        return n = n || function () {}, "function" == typeof i && (i = r, r = o), r ? d(t, e, n, i) : setTimeout(function () {
                            d(t, e, n, i)
                        }, 4), p
                    }, p.config = function (e) {
                        return p(e)
                ...
                function t(t) {
                    ...
                    if ((t = e.event.fix(s)).type = "mousewheel", "detail" in s && (p = -1 * s.detail), "wheelDelta" in s && (p = s.wheelDelta), "wheelDeltaY" in s && (p = s.wheelDeltaY), "wheelDeltaX" in s && (d = -1 * s.wheelDeltaX), "axis" in s && s.axis === s.HORIZONTAL_AXIS && (d = -1 * p, p = 0), c = 0 === p ? d : p, "deltaY" in s && (c = p = -1 * s.deltaY), "deltaX" in s && (d = s.deltaX, 0 === p && (c = -1 * d)), 0 !== p || 0 !== d) {
                        ...
                        if (h = Math.max(Math.abs(p), Math.abs(d)), (!o || h < o) && (o = h, i(s, h) && (o /= 40)), i(s, h) && (c /= 40, d /= 40, p /= 40), c = Math[c >= 1 ? "floor" : "ceil"](c / o), d = Math[d >= 1 ? "floor" : "ceil"](d / o), p = Math[p >= 1 ? "floor" : "ceil"](p / o), u.settings.normalizeOffset && this.getBoundingClientRect) {
                            var y = this.getBoundingClientRect();
                            f = t.clientX - y.left, g = t.clientY - y.top
                        }
                        return t.deltaX = d, t.deltaY = p, t.deltaFactor = o, t.offsetX = f, t.offsetY = g, t.deltaMode = 0, a.unshift(t, c, d, p), r && clearTimeout(r), r = setTimeout(n, 200), (e.event.dispatch || e.event.handle).apply(this, a)
                    }
                }
            ...
            }, "function" == typeof t.define && t.define.amd ? t.define("jquery-mousewheel", ["jquery"], n) : "object" == typeof exports ? module.exports = n : n(e), t.define("jquery.select2", ["jquery", "jquery-mousewheel", "./select2/core", "./select2/defaults", "./select2/utils"], function (e, t, n, i, r) {
